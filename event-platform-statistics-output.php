        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            ...
            <form class="eps-metadata-form mx-auto" action="" method="post">
                <div class="form-group mb-3">
                    <input type="text" class="form-control form-control-sm" id="eps-metadata-add-name" name="eps-metadata-add-name" placeholder="Введите название" required="true">
                </div>
                <div class="form-group mb-3">
                    <input type="text" class="form-control form-control-sm" id="eps-metadata-add-key" name="eps-metadata-add-key" list="eps-metadata-datalist" placeholder="Укажите ключ" required="true">
                </div>
