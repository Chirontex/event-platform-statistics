...
?>
    <form class="eps-column mx-auto text-center" action="" method="post">
        <div class="mb-5">
            <input type="checkbox" class="form-check-input" name="eps-download-participants" id="eps-download-participants" value="true" checked="true">
        ...
        <button type="submit" class="btn btn-primary mx-auto">Скачать</button>
    </form>
</div>